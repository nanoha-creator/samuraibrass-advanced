...
<head prefix="og: http://ogp.me/ns#">
  ...
  <meta property="og:description" content="日本人へのTOEFL指導歴豊かな講師陣のコーチング型TOEFLスクールのトップページ" />
  <meta property="og:site_name" content="Engress" />
  <meta property="og:image" content="<?php echo esc_url(get_theme_file_uri('img/fv@2x.jpg')) ?>" />
          ...
          <section class="ly_section ly_section__blue">
            ...
            <div class="bl_section_body">
              <div class="bl_cardUnit bl_cardUnit__col3">
                <div class="bl_card">
                  <p class="bl_card_topTxt"><?php echo get_post_meta(get_the_ID(), 'title_1', true) ?></p>
                  <figure class="bl_card_imgWrapper">
                    <img src="<?php echo wp_get_attachment_url(get_post_meta(get_the_ID(), 'image_1', true)); ?>" alt="" width="125" height="140">
                  </figure>
                  <div class="bl_card_body">
                    <span class="bl_card_title"><?php echo get_post_meta(get_the_ID(), 'jobs_1', true) ?></span>
                    <span class="bl_card_name"><?php echo get_post_meta(get_the_ID(), 'name_1', true) ?></span>
                    <span class="bl_card_result"><?php echo get_post_meta(get_the_ID(), 'result_1', true) ?></span>
                  </div>
                  <!-- /.bl_card_body -->
                </div>
                <!-- /.bl_card -->
                <div class="bl_card">
                  <p class="bl_card_topTxt"><?php echo get_post_meta(get_the_ID(), 'title_2', true) ?></p>
                  <figure class="bl_card_imgWrapper">
                    <img src="<?php echo wp_get_attachment_url(get_post_meta(get_the_ID(), 'image_2', true)); ?>" alt="" width="125" height="140">
                  </figure>
                  <div class="bl_card_body">
                    <span class="bl_card_title"><?php echo get_post_meta(get_the_ID(), 'jobs_2', true) ?></span>
                    <span class="bl_card_name"><?php echo get_post_meta(get_the_ID(), 'name_2', true) ?></span>
                    <span class="bl_card_result"><?php echo get_post_meta(get_the_ID(), 'result_2', true) ?></span>
                  </div>
                  <!-- /.bl_card_body -->
                </div>
                <!-- /.bl_card -->
                <div class="bl_card">
                  <p class="bl_card_topTxt"><?php echo get_post_meta(get_the_ID(), 'title_3', true) ?></p>
                  <figure class="bl_card_imgWrapper">
                    <img src="<?php echo wp_get_attachment_url(get_post_meta(get_the_ID(), 'image_3', true)); ?>" alt="" width="125" height="140">
                  </figure>
                  <div class="bl_card_body">
                    <span class="bl_card_title"><?php echo get_post_meta(get_the_ID(), 'jobs_3', true) ?></span>
                    <span class="bl_card_name"><?php echo get_post_meta(get_the_ID(), 'name_3', true) ?></span>
                    <span class="bl_card_result"><?php echo get_post_meta(get_the_ID(), 'result_3', true) ?></span>
                  </div>
                  <!-- /.bl_card_body -->
                </div>
                <!-- /.bl_card -->
