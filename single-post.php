                                            ...
                                            <li>
                                                <a class="bl_media bl_media__small" href="<?php echo esc_url(the_permalink()); ?>">
                                                    ...
                                                    <div class="bl_media_body bl_media_body__small">
                                                        <h3 class="bl_media_ttl bl_media_ttl__small js_textTrim" data-num="35"><?php the_title(); ?></h3>
                                                    </div>
                            ...
                            <div class="bl_postSide_body">
                                <ul class="bl_horizList bl_horizList__simple">
                                    ...
                                    foreach ($categories as $category) : ?>
                                        <li><a href="<?php echo esc_url(the_permalink()); ?>"><?php echo $category->cat_name; ?></a></li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
                        </div>
